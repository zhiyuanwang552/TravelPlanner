...
namespace TravelPlanner.Controllers
{
    public class CartsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CartID,Total_Price,Total_Duration")] Cart cart)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CartID,Total_Price,Total_Duration")] Cart cart)
        {
            if (id != cart.CartID)
            {
                return NotFound();
